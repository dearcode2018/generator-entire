...
public class ConstantFactory implements IConstantFactory {
    ...
    public String getMenuNameByCode(String code) {
        if (ToolUtil.isEmpty(code)) {
            ...
            Menu menu = menuMapper.selectOne(query);
            if (menu == null) {
                return "";
            } else {
                return menu.getName();
