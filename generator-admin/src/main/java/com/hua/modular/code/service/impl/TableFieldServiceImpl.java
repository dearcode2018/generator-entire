...
import com.hua.core.model.enmus.BooleanType;
import com.hua.core.support.CollectionKit;
import com.hua.modular.code.dao.TableFieldDao;
...
public class TableFieldServiceImpl implements ITableFieldService {
    ...
    public TableFieldModel selectOne(TableFieldModel entity) {
    	Wrapper<TableFieldModel> query = new QueryWrapper<>(entity);	
    	
        return tableFieldDao.selectOne(query);
    }
    ...
    @Override
    public List<TableFieldModel> selectPage(Page<TableFieldModel> pagination, TableFieldModel model, Wrapper<TableFieldModel> wrapper) {
