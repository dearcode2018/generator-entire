...
import com.hua.common.constant.factory.MutiStrFactory;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
    	...
    	query.eq("name", dictName);
    	 List<Dict> dicts = dictMapper.selectList(query);
        // List<Dict> dicts = dictMapper.selectList(new QueryWrapper<Dict>().eq("name", dictName).and().eq("pid", 0));
