...
import com.hua.common.persistence.dao.DictMapper;
import com.hua.common.persistence.model.Dict;
import com.hua.core.base.controller.BaseController;
import com.hua.core.log.LogObjectHolder;
import com.hua.core.util.ToolUtil;
import com.hua.modular.system.dao.DictDao;
import com.hua.modular.system.service.IDictService;
import com.hua.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.hua.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.hua.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.hua.common.constant.Dict.DeleteDict)
