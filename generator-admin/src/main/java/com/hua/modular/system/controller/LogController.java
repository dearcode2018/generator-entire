...
import com.hua.common.constant.state.BizLogType;
...
import com.hua.core.support.BeanKit;
import com.hua.modular.system.dao.LogDao;
import com.hua.modular.system.warpper.LogWarpper;
...
public class LogController extends BaseController {
    ...
    public Object list(@RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime, @RequestParam(required = false) String logName, @RequestParam(required = false) Integer logType) {
        ...
        List<Map<String, Object>> result = logDao.getOperationLogs(page, beginTime, endTime, logName, 
        		BizLogType.valueOf(logType), null, true);
