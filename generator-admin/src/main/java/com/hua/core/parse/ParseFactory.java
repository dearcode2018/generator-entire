 ...
 * the License.
 */
package com.hua.core.parse;

import com.hua.core.db.exception.GenerationRunTimeException;
import com.hua.core.parse.impl.BeetlParseImpl;
import com.hua.core.parse.impl.FreeMarkerParseImpl;

import static com.hua.core.GenCoreConstant.BEETL;
import static com.hua.core.GenCoreConstant.FREEMARKER;
