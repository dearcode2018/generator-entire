/**
 * 描述: 
 * ${g.entityName}DaoTest.java
 * 
 * @author qye.zheng
 *  version 1.0
 */
package com.hua.test.dao.local;
...
import com.hua.test.common.BaseDaoTest;
import ${g.codePackage}.dao.local.${g.entityName}Dao;

/**
 * 
 * @type ${g.entityName}DaoTest
